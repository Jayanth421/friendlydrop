  ...
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-stone-50">Loading...</div>}>
      <LoginAuthPanel
        ...
        redirectUrls={{
          customer: "/account", // Customer dashboard within main website
          vendor: "https://vendor.friendlydrop.in/dashboard", // Redirect to vendor subdomain
          admin: "https://admin.friendlydrop.in/dashboard" // Redirect to admin subdomain
        }}
      />
    </Suspense>
  );
