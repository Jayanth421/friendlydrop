...
import { Search, ShieldCheck, LogOut, Bell } from "lucide-react";
      ...
      <div className="rounded-2xl border border-stone-100 bg-white/90 px-4 py-4 shadow-sm backdrop-blur sm:px-5">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-stone-500">Welcome back to your store</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Button
              variant="ghost"
              size="sm"
              className="h-11 rounded-xl gap-2 text-stone-600 hover:bg-stone-100 relative"
              title="Notifications"
            >
